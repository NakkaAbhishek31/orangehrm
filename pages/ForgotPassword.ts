...
constructor(page:Page){
 ...
 this.resetPasswordPageHeading=page.getByRole('heading', { name: 'Reset Password' });
 this.errorValidation=page.locator('span.oxd-text.oxd-text--span.oxd-input-field-error-message.oxd-input-group__message')
 this.resetSuccessHeading = page.getByRole('heading', {name: /Reset Password link sent successfully/i,});
