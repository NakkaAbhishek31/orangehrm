...
- Location: tests\Admin\admin-users.spec.ts:313:7
...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto178643262541090 Test User' }).first()
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto178643262541090 Test User' }).first()
...
- textbox "Type for hints...": Auto178643262541090 Test User
- listbox:
