...
- Location: tests\PIM\pim-employee.spec.ts:178:8
...
```ts
  ...
  176 |   }
  177 | 
  178 |   test.only("TC_PIM_035 - Disabled employee account should not login @negative @security @account @regression", async ({ page, loginPage, navigationPage, dashboardPage, pimPage }) => {
