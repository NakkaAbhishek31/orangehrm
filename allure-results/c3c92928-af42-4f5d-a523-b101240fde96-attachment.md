...
```
TimeoutError: locator.innerText: Timeout 70000ms exceeded.
Call log:
  - waiting for locator('.oxd-table-body .oxd-table-card').filter({ hasText: '0399' }).locator('.oxd-table-cell').nth(2)
