...
Received string:  "https://opensource-demo.orangehrmlive.com/web/index.php/pim/viewPersonalDetails/empNumber/289"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    22 × locator resolved to <html>…</html>
       - unexpected value "https://opensource-demo.orangehrmlive.com/web/index.php/pim/viewPersonalDetails/empNumber/289"
...
- banner:
  ...
  - list:
    - listitem:
      - img "profile picture"
      - paragraph: Auto1786431008662282 User
      - text: 
  - navigation "Topbar Menu":
    - list:
      - button ""
- heading "Auto1786431008662282 User" [level=6]
- img "profile picture"
- tablist:
  - tab "Personal Details":
    - link "Personal Details":
      - /url: /web/index.php/pim/viewPersonalDetails/empNumber/289
  - tab "Contact Details":
    - link "Contact Details":
      - /url: /web/index.php/pim/contactDetails/empNumber/289
  - tab "Emergency Contacts":
    - link "Emergency Contacts":
      - /url: /web/index.php/pim/viewEmergencyContacts/empNumber/289
  - tab "Dependents":
    - link "Dependents":
      - /url: /web/index.php/pim/viewDependents/empNumber/289
  - tab "Immigration":
    - link "Immigration":
      - /url: /web/index.php/pim/viewImmigration/empNumber/289
  - tab "Job":
    - link "Job":
      - /url: /web/index.php/pim/viewJobDetails/empNumber/289
  - tab "Salary":
    - link "Salary":
      - /url: /web/index.php/pim/viewSalaryList/empNumber/289
  - tab "Report-to":
    - link "Report-to":
      - /url: /web/index.php/pim/viewReportToDetails/empNumber/289
  - tab "Qualifications":
    - link "Qualifications":
      - /url: /web/index.php/pim/viewQualifications/empNumber/289
  - tab "Memberships":
    - link "Memberships":
      - /url: /web/index.php/pim/viewMemberships/empNumber/289
- heading "Personal Details" [level=6]
- separator
- text: Employee Full Name*
- textbox "First Name": Auto1786431008662282
- textbox "Middle Name": Test
- textbox "Last Name": User
- separator
- text: Employee Id
- textbox [disabled]: "0487"
- text: Other Id
- textbox
