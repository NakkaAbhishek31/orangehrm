...
Locator: locator('.oxd-table-body .oxd-table-card').nth(15).locator('.oxd-table-cell').nth(2)
Expected: "Admin"
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('.oxd-table-body .oxd-table-card').nth(15).locator('.oxd-table-cell').nth(2)
...
- table:
  ...
  - rowgroup:
    - row " 123456 Admin John Smith Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "123456"
      ...
      - cell " ":
        - button ""
        - button ""
    - row " <html> Admin Rick Bashirian Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "<html>"
      ...
      - cell " ":
        - button ""
        - button ""
    - row " aaaaaa Admin Chris Brown Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "aaaaaa"
    ...
    - row " Admin Admin sd i Enabled  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " Admin_1 Admin Admin 1 Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "Admin_1"
      ...
      - cell " ":
        - button ""
        - button ""
    - row " kunaal Admin Rick Bashirian Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "kunaal"
      ...
      - cell " ":
        - button ""
        - button ""
    - row " qa_1786005423524_70796 Admin Employee 1 Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "qa_1786005423524_70796"
      - cell "Admin"
      - cell "Employee 1"
      - cell "Enabled"
      - cell " ":
        - button ""
        - button ""
    - row " qa_1786005477439_22289 Admin Employee 1 Disabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "qa_1786005477439_22289"
      - cell "Admin"
      - cell "Employee 1"
      - cell "Disabled"
      - cell " ":
        - button ""
        - button ""
    - row " Samyy Admin Alo Aminn Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "Samyy"
      ...
      - cell " ":
        - button ""
        - button ""
    - row " shubham Admin Admin 1 Disabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "shubham"
    ...
    - row " user@321 Admin Admin 1 Enabled  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " vivek007 Admin sd i Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "vivek007"
