...
- Name: Admin\admin-users.spec.ts >> Admin - System Users >> TC_ADMIN_066 - Admin should filter System Users by disabled status @positive @filter @status @regression
- Location: tests\Admin\admin-users.spec.ts:788:7
        ...
        - generic [ref=f7e160]:
          - generic [ref=f7e165]:
            ...
            - generic [ref=f7e177]:
              ...
              - textbox "Type for hints..." [ref=f7e183]: Auto178781832617353 Test User
            - generic [ref=f7e185]:
              - generic [ref=f7e186]: Status*
              - generic [ref=f7e190] [cursor=pointer]:
                - generic [ref=f7e191]: Disabled
                - generic [ref=f7e192]: 
            - generic [ref=f7e195]:
              - generic [ref=f7e196]: Username*
              - textbox [ref=f7e199]: ess178781832617353
          - generic [ref=f7e201]:
            - generic [ref=f7e202]:
