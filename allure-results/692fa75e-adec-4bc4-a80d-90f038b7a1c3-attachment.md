...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Wrong3eb31348' }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Wrong3eb31348' }).first()
...
- separator
- text: Employee Name
- textbox "Type for hints...": Wrong3eb31348
- listbox:
  ...
  - rowgroup:
    ...
    - row " 05100102 Anu Raju  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " 174164672 Cancel1d68f364 Test Delete  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "174164672"
      - cell "Cancel1d68f364 Test"
      - cell "Delete"
      - cell
      - cell
      - cell
    ...
    - row " 159616969 Cancelef5b5aa2 Test Delete  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " satish598 George akhill Russell HR Manager Full-Time Permanent Human Resources ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "satish598"
    ...
    - row " MD Sharif MD Sharif Nawaz  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " 783261280 Mismatch3e4edc8c Test User  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "783261280"
      - cell "Mismatch3e4edc8c Test"
      - cell "User"
      - cell
      - cell
      - cell
    ...
    - row " 640207189 Mismatch8547468e Test User  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " 074147788 Open2549a20f Test Details  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "074147788"
      - cell "Open2549a20f Test"
      - cell "Details"
      - cell
      - cell
      - cell
