...
- Location: tests\Leave\leave.spec.ts:540:7
...
- generic [ref=f2e3]:
  ...
  - generic [ref=f2e152]:
    - generic [ref=f2e154]:
      ...
      - generic [ref=f2e242]:
        - generic [ref=f2e243]: (2) Records Found
        - table [ref=f2e246]:
          - rowgroup [ref=f2e247]:
            - row [ref=f2e248]:
            ...
            - row [ref=f2e265]:
              - cell "" [ref=f2e266]:
                - generic [ref=f2e269] [cursor=pointer]:
                  - checkbox "" [ref=f2e270]
                  - generic [ref=f2e271]: 
              - cell "2026-11-12" [ref=f2e273]
              - cell "Rajaa P" [ref=f2e275]
              - cell "CAN - Vacation" [ref=f2e277]
              - cell "99.00" [ref=f2e279]
              - cell "1.00" [ref=f2e281]
              - cell "Pending Approval (1.00)" [ref=f2e283]
              - cell [ref=f2e285]
              - cell [ref=f2e286]:
                - generic [ref=f2e287]:
                  - button "Approve" [ref=f2e288] [cursor=pointer]
                  - button "Reject" [ref=f2e289] [cursor=pointer]
                  - listitem [ref=f2e290]:
            ...
            - row [ref=f2e294]:
              - cell "" [ref=f2e295]:
                - generic [ref=f2e298] [cursor=pointer]:
                  - checkbox "" [ref=f2e299]
                  - generic [ref=f2e300]: 
              - cell "2026-09-10" [ref=f2e302]
              - cell "Rajaa P" [ref=f2e304]
              - cell "CAN - Personal" [ref=f2e306]
              - cell "99.00" [ref=f2e308]
              - cell "1.00" [ref=f2e310]
              - cell "Pending Approval (1.00)" [ref=f2e312]
              - cell [ref=f2e314]
              - cell [ref=f2e315]:
                - generic [ref=f2e316]:
                  - button "Approve" [ref=f2e317] [cursor=pointer]
                  - button "Reject" [ref=f2e318] [cursor=pointer]
                  - listitem [ref=f2e319]:
                    - button "" [ref=f2e320] [cursor=pointer]
    - generic [ref=f2e323]:
      - paragraph [ref=f2e324]: OrangeHRM OS 5.9
      - paragraph [ref=f2e325]:
        - text: © 2005 - 2026
        - link "OrangeHRM, Inc" [ref=f2e326] [cursor=pointer]:
