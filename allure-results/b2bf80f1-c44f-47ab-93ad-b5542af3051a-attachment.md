...
- Name: Performance\performance.spec.ts >> Performance - Employee Reviews >> TC_PERFORMANCE_206 - Reset should clear the selected job title @positive @reset @filter @regression
- Location: tests\Performance\performance.spec.ts:367:5
