        ...
        - generic [ref=f10e168]:
          - generic [ref=f10e170]:
            - generic [ref=f10e172]:
              ...
              - textbox [ref=f10e176]: updated1786554182851997
            - generic [ref=f10e178]:
...
```ts
  ...
  611 |   });
  612 | 
  613 |   test.only("TC_ADMIN_063 - Admin should update an existing System User username @positive @edit @regression", async ({
  614 |     navigationPage,
  615 |     pimPage,
  616 |     adminPage,
  617 |   }) => {
