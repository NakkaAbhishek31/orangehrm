...
- Location: tests\Admin\admin-users.spec.ts:209:7
...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1787818037310838 Test User' }).first()
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 20000ms
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1787818037310838 Test User' }).first()
  - Test timeout of 120000ms exceeded.
...
- textbox "Type for hints...": Auto1787818037310838 Test User
- listbox:
  - option "Searching...."
