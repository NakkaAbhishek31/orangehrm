...
Locator: locator('.oxd-table-body .oxd-table-card').nth(7).locator('.oxd-table-cell').nth(2)
Expected: "Admin"
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('.oxd-table-body .oxd-table-card').nth(7).locator('.oxd-table-cell').nth(2)
...
- table:
  ...
  - rowgroup:
    - row " A8DCo2708 Admin A8DCo 010Z Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "A8DCo2708"
    ...
    - row " Admin Admin manda user Enabled  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " Greatkali Admin manda user Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "Greatkali"
      ...
      - cell " ":
        - button ""
        - button ""
    - row " pwuser_1787817828105_lym4p Admin manda user Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "pwuser_1787817828105_lym4p"
      - cell "Admin"
      - cell "manda user"
      - cell "Enabled"
      - cell " ":
        - button ""
        - button ""
    - row " test123 Admin Virat Kohli Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "test123"
      ...
      - cell " ":
        - button ""
        - button ""
    - row " Tester12345 Admin manda user Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "Tester12345"
      ...
      - cell " ":
        - button ""
        - button ""
    - row " Undertaker Admin manda user Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "Undertaker"
