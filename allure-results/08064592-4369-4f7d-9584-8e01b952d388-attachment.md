...
- Name: PIM\pim-employee-list.spec.ts >> PIM Employee List >> TC_PIM_010 - Admin should navigate through Employee List pages @pagination @regression
- Location: tests\PIM\pim-employee-list.spec.ts:155:7
