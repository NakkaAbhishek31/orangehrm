...
- Name: Admin\admin-users.spec.ts >> TC_PIM_088 - Admin should open employee details after searching by employee ID @positive @navigation @regression
- Location: tests\Admin\admin-users.spec.ts:3514:5
