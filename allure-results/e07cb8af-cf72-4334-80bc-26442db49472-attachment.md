...
- separator
- text: Name
- paragraph: RejectCandidate1787821952416 Test Candidate
- text: Vacancy
- paragraph: N/A
- text: Hiring Manager
- paragraph: N/A
...
- separator
- text: Full Name*
- textbox "First Name" [disabled]: RejectCandidate1787821952416
- textbox "Middle Name" [disabled]: Test
- textbox "Last Name" [disabled]: Candidate
- text: Job Vacancy -- Select --  Email*
- textbox "Type here" [disabled]: rejectcandidate1787821952416@example.com
- text: Contact Number
...
- table:
  ...
  - rowgroup:
    - row "2026-08-27 Demo Open Kumar added RejectCandidate1787821952416 Test Candidate":
      - cell "2026-08-27"
      - cell "Demo Open Kumar added RejectCandidate1787821952416 Test Candidate"
      - cell
