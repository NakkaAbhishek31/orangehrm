...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Wrong07f04e58' }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Wrong07f04e58' }).first()
...
- separator
- text: Employee Name
- textbox "Type for hints...": Wrong07f04e58
- listbox:
  ...
  - rowgroup:
    ...
    - row " 640207189 Mismatch8547468e Test User  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " 174994132 Mismatchaadea1ed Test User  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "174994132"
      - cell "Mismatchaadea1ed Test"
      - cell "User"
      - cell
      - cell
      - cell
