...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786453225761798 Test User' }).first()
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786453225761798 Test User' }).first()
...
- textbox "Type for hints...": Auto1786453225761798 Test User
- listbox:
