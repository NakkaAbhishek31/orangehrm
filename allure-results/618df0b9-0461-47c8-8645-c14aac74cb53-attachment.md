...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1785496449937 test user' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1785496449937 test user' })
  ...
  - rowgroup:
    ...
    - row " 0525 Auto1785496259117 Test User  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " 0526 Auto1785496287754 updatedTest updatedUser  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "0526"
      - cell "Auto1785496287754 updatedTest"
      - cell "updatedUser"
      - cell
      - cell
      - cell
      ...
      - cell " ":
        - button ""
        - button ""
    - row " 0531 Auto1785496449937 test user  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "0531"
      - cell "Auto1785496449937 test"
      - cell "user"
      - cell
      - cell
      - cell
