...
- Location: tests\Admin\admin-users.spec.ts:134:8
...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786517851101312 Test User' }).first()
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786517851101312 Test User' }).first()
...
- textbox "Type for hints...": Auto1786517851101312 Test User
- listbox:
