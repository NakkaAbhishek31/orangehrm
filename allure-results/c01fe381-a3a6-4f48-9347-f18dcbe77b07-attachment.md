  ...
  - rowgroup:
    ...
    - row " FreeWave Technologies, Inc. FWT - Phase 1  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " Internal General HR Tasks iFCekKcjlK user  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "Internal"
      - cell "General HR Tasks"
      - cell "iFCekKcjlK user"
      - cell " ":
        - button ""
        - button ""
    ...
    - row " Global Corp and Co Global Software phase - 2  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " The Priceline Group Priceline Group - Phase 1 iFCekKcjlK user  ":
      - cell "":
        - checkbox ""
        - text: 
      ...
      - cell " ":
        - button ""
        - button ""
    - row " Internal Recruitment iFCekKcjlK user  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "Internal"
      ...
      - cell " ":
        - button ""
        - button ""
    - row " Internal Training and Development iFCekKcjlK user  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "Internal"
