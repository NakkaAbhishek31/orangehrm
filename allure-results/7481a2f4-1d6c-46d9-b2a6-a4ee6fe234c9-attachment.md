...
Locator: locator('.orangehrm-container').locator('.oxd-table-body .oxd-table-card').first().locator('.oxd-table-cell').nth(1)
...
Call log:
  ...
  - waiting for locator('.orangehrm-container').locator('.oxd-table-body .oxd-table-card').first().locator('.oxd-table-cell').nth(1)
    9 × locator resolved to <div role="cell" class="oxd-table-cell oxd-padding-cell">…</div>
      - unexpected value "Software Engineer"
...
> 375 |         ).toContainText(selectedVacancy);
  ...
  454 | 
  455 |     await expect(
  456 |       recruitmentPage.hiringManagerDropdown
  457 |     ).toContainText(
  458 |       data.defaultDropdownValue
  459 |     );
  460 |   }
  461 | );
  462 | });
