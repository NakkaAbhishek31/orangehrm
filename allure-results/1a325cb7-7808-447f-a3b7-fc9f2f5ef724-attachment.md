...
Locator: locator('.oxd-table-body .oxd-table-card').nth(2).locator('.oxd-table-cell').nth(2)
Expected: "Admin"
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('.oxd-table-body .oxd-table-card').nth(2).locator('.oxd-table-cell').nth(2)
