...
- Name: PIM\pim-employee.spec.ts >> TC_PIM_005 - Admin should search using employee ID and employee name @positive @regression
- Location: tests\PIM\pim-employee.spec.ts:130:5
...
- generic [ref=f3e2]:
  ...
  - generic [ref=f3e205] [cursor=pointer]:
    - generic [ref=f3e206]:
      - generic [ref=f3e207]: 
      - generic [ref=f3e210]:
        - paragraph [ref=f3e211]: Success
        - paragraph [ref=f3e212]: Successfully Saved
    - button "×" [ref=f3e214]
```
