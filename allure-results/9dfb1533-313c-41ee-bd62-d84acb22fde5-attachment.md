...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786452740333991 Test User' }).first()
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786452740333991 Test User' }).first()
...
- textbox "Type for hints...": Auto1786452740333991 Test User
- listbox:
