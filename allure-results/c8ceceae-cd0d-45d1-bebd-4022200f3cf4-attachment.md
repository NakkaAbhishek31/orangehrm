...
- separator
- text: Name
- paragraph: SearchCandidate1786948537591 Test User
- text: Vacancy
- paragraph: N/A
- text: Hiring Manager
- paragraph: N/A
...
- separator
- text: Full Name*
- textbox "First Name" [disabled]: SearchCandidate1786948537591
- textbox "Middle Name" [disabled]: Test
- textbox "Last Name" [disabled]: User
- text: Job Vacancy -- Select --  Email*
- textbox "Type here" [disabled]: searchcandidate1786948537591@example.com
- text: Contact Number
...
- table:
  ...
  - rowgroup:
    - row "2026-17-08 aMTZUDRuhb hello king added SearchCandidate1786948537591 Test User":
      - cell "2026-17-08"
      - cell "aMTZUDRuhb hello king added SearchCandidate1786948537591 Test User"
      - cell
