...
- Name: Time\time.spec.ts >> Time - Timesheets, Attendance and Reports >> TC_TIME_167 - Required validation should appear when viewing a timesheet without selecting an employee @negative @validation @regression
- Location: tests\Time\time.spec.ts:56:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_CLOSED at https://opensource-demo.orangehrmlive.com/
Call log:
