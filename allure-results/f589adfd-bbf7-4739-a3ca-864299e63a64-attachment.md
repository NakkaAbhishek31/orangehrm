...
Locator:  locator('.oxd-table-body .oxd-table-card').filter({ has: locator('.oxd-table-cell').nth(1).getByText('E8KFID31WI', { exact: true }) })
Expected: 1
Received: 0
Timeout:  10000ms
...
Call log:
  ...
  - waiting for locator('.oxd-table-body .oxd-table-card').filter({ has: locator('.oxd-table-cell').nth(1).getByText('E8KFID31WI', { exact: true }) })
    ...
    - generic [ref=f7e146]:
      ...
      - generic [ref=f7e226]:
        ...
        - generic [ref=f7e230]:
          ...
          - generic [ref=f7e232]: (2) Records Found
        - table [ref=f7e235]:
          - rowgroup [ref=f7e236]:
            - row [ref=f7e237]:
            ...
            - row [ref=f7e268] [cursor=pointer]:
              - cell "" [ref=f7e269]:
                - generic [ref=f7e272]:
                  - checkbox "" [ref=f7e273]
                  - generic [ref=f7e274]: 
              - cell "E8KL0WOC2B" [ref=f7e276]
              - cell "BulkB1785580559872 Test" [ref=f7e278]
            ...
            - row [ref=f7e293] [cursor=pointer]:
              - cell "" [ref=f7e294]:
                - generic [ref=f7e298]:
                  - checkbox "" [ref=f7e299]
                  - generic [ref=f7e300]: 
              - cell "muser" [ref=f7e302]
              - cell "manda akhil" [ref=f7e304]
              - cell "user" [ref=f7e306]
              - cell "HR Manager" [ref=f7e308]
              - cell "Full-Time Permanent" [ref=f7e310]
              - cell "Human Resources" [ref=f7e312]
              - cell [ref=f7e314]
              - cell [ref=f7e315]:
                - button "" [ref=f7e317]
    - generic [ref=f7e320]:
      - paragraph [ref=f7e321]: OrangeHRM OS 5.9
      - paragraph [ref=f7e322]:
        - text: © 2005 - 2026
        - link "OrangeHRM, Inc" [ref=f7e323] [cursor=pointer]:
