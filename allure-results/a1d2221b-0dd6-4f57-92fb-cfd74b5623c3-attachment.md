...
Locator:  locator('.oxd-table-body .oxd-table-card').filter({ hasText: '150083357' }).locator('.oxd-table-cell').nth(1)
Expected: "150083357"
Received: ""

Call log:
  - Expect "toHaveText" with timeout 10000ms
  - waiting for locator('.oxd-table-body .oxd-table-card').filter({ hasText: '150083357' }).locator('.oxd-table-cell').nth(1)
        ...
        - list [ref=f5e123]:
          - listitem [ref=f5e124]:
            - generic [ref=f5e125] [cursor=pointer]:
              ...
              - paragraph [ref=f5e127]: 12345 899776
              - generic [ref=f5e128]: 
            ...
            - row [ref=f5e268] [cursor=pointer]:
              - cell "" [ref=f5e269]:
                - generic [ref=f5e272]:
                  - checkbox "" [ref=f5e273]
                  - generic [ref=f5e274]: 
              - cell "150083357" [ref=f5e276]
              - cell "Cancel32c596b5 Test" [ref=f5e278]
              - cell "Delete" [ref=f5e280]
              - cell [ref=f5e282]
              - cell [ref=f5e283]
              - cell [ref=f5e284]
              - cell [ref=f5e285]
