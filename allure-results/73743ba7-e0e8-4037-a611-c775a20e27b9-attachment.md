...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1785498323185 test user' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1785498323185 test user' })
...
- listbox:
  ...
  - option "Auto1785498156058 updatedTest updatedUser"
  ...
  - rowgroup:
    ...
    - row " FT97410 AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " FT97865316 AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "FT97865316"
      ...
      - cell " ":
        - button ""
        - button ""
    - row " FT97844716 AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "FT97844716"
