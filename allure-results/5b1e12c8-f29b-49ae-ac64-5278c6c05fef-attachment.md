...
Locator:  locator('.oxd-table-body .oxd-table-card').filter({ has: locator('.oxd-table-cell').nth(1).getByText('ERS8TFWIMQ', { exact: true }) })
Expected: 1
Received: 0

Call log:
  - Expect "toHaveCount" with timeout 10000ms
  - waiting for locator('.oxd-table-body .oxd-table-card').filter({ has: locator('.oxd-table-cell').nth(1).getByText('ERS8TFWIMQ', { exact: true }) })
    ...
    - generic [ref=f7e146]:
      ...
      - generic [ref=f7e226]:
        ...
        - generic [ref=f7e230]:
          ...
          - generic [ref=f7e232]: (4) Records Found
        - table [ref=f7e235]:
          - rowgroup [ref=f7e236]:
            - row [ref=f7e237]:
          ...
          - rowgroup [ref=f7e266]:
            - row [ref=f7e268] [cursor=pointer]:
              - cell "" [ref=f7e269]:
                - generic [ref=f7e272]:
                  - checkbox "" [ref=f7e273]
                  - generic [ref=f7e274]: 
              - cell "ERSYDKWVCL" [ref=f7e276]
              - cell "Auto1785915180522 Test" [ref=f7e278]
            ...
            - row [ref=f7e293] [cursor=pointer]:
              - cell "" [ref=f7e294]:
                - generic [ref=f7e297]:
                  - checkbox "" [ref=f7e298]
                  - generic [ref=f7e299]: 
              - cell "ERSYDW4EK9" [ref=f7e301]
              - cell "Auto1785915181204 Test" [ref=f7e303]
            ...
            - row [ref=f7e318] [cursor=pointer]:
              ...
              - cell [ref=f7e340]:
                - button "" [ref=f7e342]
            - row [ref=f7e345] [cursor=pointer]:
              - cell "" [ref=f7e346]:
                - generic [ref=f7e349]:
                  - checkbox "" [ref=f7e350]
                  - generic [ref=f7e351]: 
              - cell "0769" [ref=f7e353]
              - cell "QATraining" [ref=f7e355]
              - cell "Demo01" [ref=f7e357]
              - cell [ref=f7e359]
              - cell [ref=f7e360]
              - cell [ref=f7e361]
              - cell [ref=f7e362]
              - cell [ref=f7e363]:
                - generic [ref=f7e364]:
                  ...
                  - button "" [ref=f7e367]
    - generic [ref=f7e370]:
      - paragraph [ref=f7e371]: OrangeHRM OS 5.9
      - paragraph [ref=f7e372]:
        - text: © 2005 - 2026
        - link "OrangeHRM, Inc" [ref=f7e373] [cursor=pointer]:
