...
- Name: Admin\admin-users.spec.ts >> Admin - System Users >> TC_ADMIN_054 - Admin should edit an existing System User status @positive @edit @regression
- Location: tests\Admin\admin-users.spec.ts:312:7
...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786452935538108 Test User' }).first()
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786452935538108 Test User' }).first()
...
- textbox "Type for hints...": Auto1786452935538108 Test User
- listbox:
