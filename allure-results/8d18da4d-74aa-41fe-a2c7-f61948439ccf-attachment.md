...
Call log:
  ...
  - waiting for locator('.oxd-loading-spinner').first()
    11 × locator resolved to <div data-v-a6dfc6a9="" class="oxd-loading-spinner"></div>
...
- generic [ref=f4e3]:
  ...
  - generic [ref=f4e144]:
    - generic [ref=f4e148]:
      - generic [ref=f4e149]:
        - generic [ref=f4e150]:
          - heading "Auto1785914970898 User" [level=6] [ref=f4e152]
          - img "profile picture" [ref=f4e155] [cursor=pointer]
        - tablist [ref=f4e156]:
          - tab [ref=f4e157]:
            - link "Personal Details" [ref=f4e158] [cursor=pointer]:
              - /url: /web/index.php/pim/viewPersonalDetails/empNumber/579
          - tab [ref=f4e159]:
            - link "Contact Details" [ref=f4e160] [cursor=pointer]:
              - /url: /web/index.php/pim/contactDetails/empNumber/579
          - tab [ref=f4e161]:
            - link "Emergency Contacts" [ref=f4e162] [cursor=pointer]:
              - /url: /web/index.php/pim/viewEmergencyContacts/empNumber/579
          - tab [ref=f4e163]:
            - link "Dependents" [ref=f4e164] [cursor=pointer]:
              - /url: /web/index.php/pim/viewDependents/empNumber/579
          - tab [ref=f4e165]:
            - link "Immigration" [ref=f4e166] [cursor=pointer]:
              - /url: /web/index.php/pim/viewImmigration/empNumber/579
          - tab [ref=f4e167]:
            - link "Job" [ref=f4e168] [cursor=pointer]:
              - /url: /web/index.php/pim/viewJobDetails/empNumber/579
          - tab [ref=f4e169]:
            - link "Salary" [ref=f4e170] [cursor=pointer]:
              - /url: /web/index.php/pim/viewSalaryList/empNumber/579
          - tab [ref=f4e171]:
            - link "Report-to" [ref=f4e172] [cursor=pointer]:
              - /url: /web/index.php/pim/viewReportToDetails/empNumber/579
          - tab [ref=f4e173]:
            - link "Qualifications" [ref=f4e174] [cursor=pointer]:
              - /url: /web/index.php/pim/viewQualifications/empNumber/579
          - tab [ref=f4e175]:
            - link "Memberships" [ref=f4e176] [cursor=pointer]:
              - /url: /web/index.php/pim/viewMemberships/empNumber/579
      - generic [ref=f4e177]:
        - generic [ref=f4e178]:
          ...
          - generic [ref=f4e181]:
            - generic [ref=f4e188]:
              ...
              - generic [ref=f4e191]:
                - textbox "First Name" [ref=f4e194]: Auto1785914970898
