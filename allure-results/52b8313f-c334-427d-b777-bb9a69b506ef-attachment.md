...
Locator:  locator('.oxd-table-body .oxd-table-card').filter({ has: locator('.oxd-table-cell').nth(1).getByText('ERJ753C54Z', { exact: true }) })
Expected: 1
Received: 0
Timeout:  10000ms
...
Call log:
  ...
  - waiting for locator('.oxd-table-body .oxd-table-card').filter({ has: locator('.oxd-table-cell').nth(1).getByText('ERJ753C54Z', { exact: true }) })
            ...
            - row [ref=f7e268] [cursor=pointer]:
              - cell "" [ref=f7e269]:
                - generic [ref=f7e272]:
                  - checkbox "" [ref=f7e273]
                  - generic [ref=f7e274]: 
              - cell "ERJLJ1X2OU" [ref=f7e276]
              - cell "BulkB1785914744493 Test" [ref=f7e278]
