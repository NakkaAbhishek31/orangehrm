...
Expected: ""
Received: "Cancel1786799330428"

Call log:
  - Expect "toHaveValue" with timeout 20000ms
  - waiting for getByRole('textbox', { name: 'Type for hints...', exact: true })
    4 × locator resolved to <input data-v-75e744cd="" placeholder="Type for hints..."/>
      - unexpected value "Cancel1786799330428"
  - Protocol error (Runtime.callFunctionOn): Internal server error, session closed.

```

```yaml
- textbox "Type for hints...": Cancel1786799330428
```
