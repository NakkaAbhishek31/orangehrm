...
- Name: PIM\pim-employee.spec.ts >> PIM Employee >> TC_PIM_034 - Employee username validation @negative @validation @account @regression
- Location: tests\PIM\pim-employee.spec.ts:164:9
