...
Locator:  locator('.oxd-table-body .oxd-table-card').locator('input[type="checkbox"]').nth(1)
Expected: checked
Received: unchecked
Timeout:  10000ms
...
Call log:
  ...
  - waiting for locator('.oxd-table-body .oxd-table-card').locator('input[type="checkbox"]').nth(1)
