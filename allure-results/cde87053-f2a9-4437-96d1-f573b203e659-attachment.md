...
- Location: tests\Admin\admin-users.spec.ts:171:8
...
Call log:
  ...
  - waiting for locator('.oxd-input-field-error-message')
    43 × locator resolved to 6 elements
        ...
        - list [ref=f4e123]:
          - listitem [ref=f4e124]:
            - generic [ref=f4e125] [cursor=pointer]:
              ...
              - paragraph [ref=f4e127]: LfVJZqyBDe user
              - generic [ref=f4e128]: 
...
```ts
  ...
  169 |   });
  170 | 
  171 |   test.only("TC_ADMIN_048 - Required validation should appear when System User fields are empty @negative @validation @regression", async ({
  172 |     page,
  173 |     navigationPage,
  174 |     adminPage,
  175 |   }) => {
