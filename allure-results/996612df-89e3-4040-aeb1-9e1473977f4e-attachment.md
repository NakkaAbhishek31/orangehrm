...
- Location: tests\Recruitment\recruitment.spec.ts:2460:5
...
- separator
- text: Name
- paragraph: HireCandidate1787039104554 Test Candidate
- text: Vacancy
- paragraph: N/A
- text: Hiring Manager
- paragraph: N/A
...
- separator
- text: Full Name*
- textbox "First Name" [disabled]: HireCandidate1787039104554
- textbox "Middle Name" [disabled]: Test
- textbox "Last Name" [disabled]: Candidate
- text: Job Vacancy -- Select --  Email*
- textbox "Type here" [disabled]: hirecandidate1787039104554@example.com
- text: Contact Number
...
- table:
  ...
  - rowgroup:
    - row "2026-18-08 manda akhil userTester added HireCandidate1787039104554 Test Candidate":
      - cell "2026-18-08"
      - cell "manda akhil userTester added HireCandidate1787039104554 Test Candidate"
      - cell
