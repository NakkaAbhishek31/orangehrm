...
- Location: tests\Admin\admin-users.spec.ts:924:7
...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'MismatchB1786453588552276' }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'MismatchB1786453588552276' }).first()
...
- separator
- text: Employee Name
- textbox "Type for hints...": MismatchB1786453588552276
- listbox:
  ...
  - rowgroup:
    ...
    - row " 0363 Christopher Mcmillan  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " EMP123 Daisy Nguyen HR Manager Full-Time Permanent Human Resources ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "EMP123"
