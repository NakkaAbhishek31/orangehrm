...
Locator: locator('div.oxd-toast-container.oxd-toast-container--bottom')
...
Call log:
  ...
  - waiting for locator('div.oxd-toast-container.oxd-toast-container--bottom')
    23 × locator resolved to <div id="oxd-toaster_1" class="oxd-toast-container oxd-toast-container--bottom"></div>
       - unexpected value ""
    ...
    - list:
      ...
      - listitem:
        - link "Reports":
          - /url: "#"
      - button ""
- heading "Auto1786421797744454 User" [level=6]
- img "profile picture"
- tablist:
  - tab "Personal Details":
    - link "Personal Details":
      - /url: /web/index.php/pim/viewPersonalDetails/empNumber/183
  - tab "Contact Details":
    - link "Contact Details":
      - /url: /web/index.php/pim/contactDetails/empNumber/183
  - tab "Emergency Contacts":
    - link "Emergency Contacts":
      - /url: /web/index.php/pim/viewEmergencyContacts/empNumber/183
  - tab "Dependents":
    - link "Dependents":
      - /url: /web/index.php/pim/viewDependents/empNumber/183
  - tab "Immigration":
    - link "Immigration":
      - /url: /web/index.php/pim/viewImmigration/empNumber/183
  - tab "Job":
    - link "Job":
      - /url: /web/index.php/pim/viewJobDetails/empNumber/183
  - tab "Salary":
    - link "Salary":
      - /url: /web/index.php/pim/viewSalaryList/empNumber/183
  - tab "Report-to":
    - link "Report-to":
      - /url: /web/index.php/pim/viewReportToDetails/empNumber/183
  - tab "Qualifications":
    - link "Qualifications":
      - /url: /web/index.php/pim/viewQualifications/empNumber/183
  - tab "Memberships":
    - link "Memberships":
      - /url: /web/index.php/pim/viewMemberships/empNumber/183
- heading "Personal Details" [level=6]
- separator
- text: Employee Full Name*
- textbox "First Name": Auto1786421797744454
- textbox "Middle Name": UpdatedTest
- textbox "Last Name": UpdatedUser
- separator
- text: Employee Id
- textbox: "0386"
- text: Other Id
