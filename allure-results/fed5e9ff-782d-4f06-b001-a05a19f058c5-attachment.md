...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1785495967752 test user' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1785495967752 test user' })
...
- listbox:
  ...
  - option "Auto1785493177827 test user"
  - option "Auto1785494708535 Test User"
- text: Employee Id
- textbox
