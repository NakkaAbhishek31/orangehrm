...
- Name: Admin\admin-users.spec.ts >> Admin - System Users >> TC_ADMIN_064 - Admin should cancel editing a System User @negative @cancel @edit @regression
- Location: tests\Admin\admin-users.spec.ts:648:7
...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786453296710513 Test User' }).first()
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786453296710513 Test User' }).first()
...
- textbox "Type for hints...": Auto1786453296710513 Test User
- listbox:
