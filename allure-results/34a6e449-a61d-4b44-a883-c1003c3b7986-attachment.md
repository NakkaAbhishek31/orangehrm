...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1785493995139' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1785493995139' })
...
- listbox:
  ...
  - option "Auto1785492318086 Test User"
  - option "Auto1785493725296 test user"
