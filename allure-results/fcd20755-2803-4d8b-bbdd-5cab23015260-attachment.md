          ...
          - generic [ref=f3e164]:
            - generic [ref=f3e165]:
              - generic [ref=f3e168]:
                ...
                - generic [ref=f3e171]:
                  - textbox "First Name" [ref=f3e174]: Auto1785578123223
                  - textbox "Middle Name" [ref=f3e177]: Test
                  - textbox "Last Name" [ref=f3e180]: User
              - generic [ref=f3e183]:
                - generic [ref=f3e184]: Employee Id
                - textbox [ref=f3e187]: "0729"
            - separator [ref=f3e188]
            - generic [ref=f3e189]:
              - paragraph [ref=f3e190]: Create Login Details
              - checkbox [checked] [ref=f3e193]
            - generic [ref=f3e196]:
              - generic [ref=f3e198]:
                - generic [ref=f3e199]: Username*
                - textbox [ref=f3e202]: user1785578123223
              - generic [ref=f3e204]:
                - generic [ref=f3e205]: Status
                - generic [ref=f3e207]:
                  - generic [ref=f3e211] [cursor=pointer]:
                    - radio "Enabled" [ref=f3e212]
                    - text: Enabled
                  - generic [ref=f3e217] [cursor=pointer]:
                    - radio "Disabled" [checked] [ref=f3e218]
                    - text: Disabled
            - generic [ref=f3e221]:
              - generic [ref=f3e222]:
                - generic [ref=f3e223]: Better
                - generic [ref=f3e224]:
                  - generic [ref=f3e225]: Password*
                  - textbox [ref=f3e228]: Test@12345
                - paragraph [ref=f3e229]: For a strong password, please use a hard to guess combination of text with upper and lower case characters, symbols and numbers
              - generic [ref=f3e231]:
                - generic [ref=f3e232]: Confirm Password*
                - textbox [ref=f3e235]: Test@12345
        - separator [ref=f3e236]
        - generic [ref=f3e237]:
          - paragraph [ref=f3e238]: "* Required"
          - button "Cancel" [ref=f3e239] [cursor=pointer]
          - button "Save" [active] [ref=f3e240] [cursor=pointer]
    - generic [ref=f3e241]:
