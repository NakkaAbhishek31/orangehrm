...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786455243740841' }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786455243740841' }).first()
...
- separator
- text: Employee Name
- textbox "Type for hints...": Auto1786455243740841
- listbox:
  ...
  - rowgroup:
    ...
    - row " 0998 ABC Abhinay Account Assistant Full-Time Permanent Engineering  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " 05989909 abcdefgh ijklm nopqrst  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "05989909"
      ...
      - cell " ":
        - button ""
        - button ""
    - row " 05989908 abcdefgh ijklm nopqrst  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "05989908"
    ...
    - row " 0999 Abhinay ABC Payroll Administrator Part-Time Internship Sales & Marketing  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " 144242 akanksha reddy bondalakunta  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "144242"
    ...
    - row " 0522 Auto1786453397200280 Test User  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " 0611 Auto1786454858255773 Test User  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "0611"
      - cell "Auto1786454858255773 Test"
      - cell "User"
      - cell
      - cell
      - cell
      ...
      - cell " ":
        - button ""
        - button ""
    - row " 0612 Auto1786454874329394 UpdatedTest UpdatedUser  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "0612"
      - cell "Auto1786454874329394 UpdatedTest"
      - cell "UpdatedUser"
      - cell
      - cell
      - cell
      ...
      - cell " ":
        - button ""
        - button ""
    - row " 0620 Auto1786455178972689 Test User  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "0620"
      - cell "Auto1786455178972689 Test"
      - cell "User"
      - cell
      - cell
      - cell
      ...
      - cell " ":
        - button ""
        - button ""
    - row " 0621 Auto178645522488835 Test User  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "0621"
      - cell "Auto178645522488835 Test"
      - cell "User"
      - cell
      - cell
      - cell
    ...
    - row " 0498 AutoB1786452936019378 Test User  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " 0607 Automation QA Tester_1786454762415  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "0607"
      - cell "Automation QA"
      - cell "Tester_1786454762415"
      - cell
      - cell
      - cell
      - cell
      - cell " ":
        - button ""
        - button ""
    - row " 0615 Automation QA Tester_1786454989963  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "0615"
      - cell "Automation QA"
      - cell "Tester_1786454989963"
      - cell
      - cell
      - cell
      - cell
      - cell " ":
        - button ""
        - button ""
    - row " 0605 Automation QA Tester_1786454718442  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "0605"
      - cell "Automation QA"
      - cell "Tester_1786454718442"
      - cell
      - cell
      - cell
      - cell
