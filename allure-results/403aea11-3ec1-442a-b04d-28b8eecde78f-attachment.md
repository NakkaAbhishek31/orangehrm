...
- Location: tests\Admin\admin-users.spec.ts:576:7
...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786432950775190 Test User' }).first()
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786432950775190 Test User' }).first()
...
- textbox "Type for hints...": Auto1786432950775190 Test User
- listbox:
