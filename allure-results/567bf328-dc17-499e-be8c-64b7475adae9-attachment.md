...
- Name: login.spec.ts >> TC_LOGIN_008 - Required validation should appear when reset username is empty @negative @validation @regression
- Location: tests\login.spec.ts:72:5
