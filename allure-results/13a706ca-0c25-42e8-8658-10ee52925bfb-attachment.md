...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786452651192110 Test User' }).first()
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786452651192110 Test User' }).first()
...
- textbox "Type for hints...": Auto1786452651192110 Test User
- listbox:
