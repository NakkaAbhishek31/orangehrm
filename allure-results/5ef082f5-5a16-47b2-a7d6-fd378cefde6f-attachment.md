...
- Name: Admin\admin-users.spec.ts >> TC_ADMIN_060 - Minimum-length validation should appear for a short System User username @negative @validation @regression
- Location: tests\Admin\admin-users.spec.ts:1351:6
...
Locator:  locator('.oxd-table-body .oxd-table-card').filter({ hasText: 'EJ7F3E2V85' })
Expected: 1
Received: 0
Timeout:  10000ms
...
Call log:
  ...
  - waiting for locator('.oxd-table-body .oxd-table-card').filter({ hasText: 'EJ7F3E2V85' })
        ...
        - list [ref=f10e123]:
          - listitem [ref=f10e124]:
            - generic [ref=f10e125] [cursor=pointer]:
              ...
              - paragraph [ref=f10e127]: Jon Snow
              - generic [ref=f10e128]: 
        ...
        - generic [ref=f10e157]:
          - generic [ref=f10e159]:
            ...
            - generic [ref=f10e169]:
              ...
              - textbox [ref=f10e173]: EJ7F3E2V85
            - generic [ref=f10e175]:
