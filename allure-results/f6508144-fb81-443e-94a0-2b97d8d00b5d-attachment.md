...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1785495211308' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1785495211308' })
...
- listbox:
  ...
  - option "Auto1785493703532 test user"
- text: Employee Id
- textbox
