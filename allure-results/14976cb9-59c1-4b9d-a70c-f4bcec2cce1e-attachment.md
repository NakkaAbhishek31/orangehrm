...
Locator: locator('.oxd-table-body .oxd-table-card').nth(13).locator('.oxd-table-cell').nth(2)
Expected: "Admin"
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('.oxd-table-body .oxd-table-card').nth(13).locator('.oxd-table-cell').nth(2)
  ...
  - rowgroup:
    ...
    - row " jamesbrown8747 Admin James Brown Enabled  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " manda user Admin mandaa user Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "manda user"
