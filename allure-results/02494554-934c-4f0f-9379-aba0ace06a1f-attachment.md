...
- Name: Recruitment\recruitment.spec.ts >> Recruitment - Candidates >> TC_RECRUITMENT_164 - Admin should reject an existing candidate successfully @negative @workflow @regression
- Location: tests\Recruitment\recruitment.spec.ts:2506:5
...
- separator
- text: Name
- paragraph: RejectCandidate1787642479826 Test Candidate
- text: Vacancy
- paragraph: N/A
- text: Hiring Manager
- paragraph: N/A
...
- separator
- text: Full Name*
- textbox "First Name" [disabled]: RejectCandidate1787642479826
- textbox "Middle Name" [disabled]: Test
- textbox "Last Name" [disabled]: Candidate
- text: Job Vacancy -- Select --  Email*
- textbox "Type here" [disabled]: rejectcandidate1787642479826@example.com
- text: Contact Number
...
- table:
  ...
  - rowgroup:
    - row "2026-25-08 Emp_YJQynJ Opens User_KwCyeJnB added RejectCandidate1787642479826 Test Candidate":
      - cell "2026-25-08"
      - cell "Emp_YJQynJ Opens User_KwCyeJnB added RejectCandidate1787642479826 Test Candidate"
      - cell
