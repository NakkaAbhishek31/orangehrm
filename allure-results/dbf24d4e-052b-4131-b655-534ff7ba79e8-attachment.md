...
- Name: PIM\pim-employee-list.spec.ts >> PIM Employee List >> TC_PIM_004 - Admin should search for an employee by name @positive @regression
- Location: tests\PIM\pim-employee-list.spec.ts:69:7
...
Call log:
  - Expect "toHaveURL" with timeout 10000ms
    23 × locator resolved to <html dir="ltr" lang="en">…</html>
