        ...
        - tablist [ref=f7e154]:
          - tab [ref=f7e155]:
            - link "Personal Details" [ref=f7e156] [cursor=pointer]:
              - /url: /web/index.php/pim/viewPersonalDetails/empNumber/340
          - tab [ref=f7e157]:
            - link "Contact Details" [ref=f7e158] [cursor=pointer]:
              - /url: /web/index.php/pim/contactDetails/empNumber/340
          - tab [ref=f7e159]:
            - link "Emergency Contacts" [ref=f7e160] [cursor=pointer]:
              - /url: /web/index.php/pim/viewEmergencyContacts/empNumber/340
          - tab [ref=f7e161]:
            - link "Dependents" [ref=f7e162] [cursor=pointer]:
              - /url: /web/index.php/pim/viewDependents/empNumber/340
          - tab [ref=f7e163]:
            - link "Immigration" [ref=f7e164] [cursor=pointer]:
              - /url: /web/index.php/pim/viewImmigration/empNumber/340
          - tab [ref=f7e165]:
            - link "Job" [ref=f7e166] [cursor=pointer]:
              - /url: /web/index.php/pim/viewJobDetails/empNumber/340
          - tab [ref=f7e167]:
            - link "Salary" [ref=f7e168] [cursor=pointer]:
              - /url: /web/index.php/pim/viewSalaryList/empNumber/340
          - tab [ref=f7e169]:
            - link "Report-to" [ref=f7e170] [cursor=pointer]:
              - /url: /web/index.php/pim/viewReportToDetails/empNumber/340
          - tab [ref=f7e171]:
            - link "Qualifications" [ref=f7e172] [cursor=pointer]:
              - /url: /web/index.php/pim/viewQualifications/empNumber/340
          - tab [ref=f7e173]:
            - link "Memberships" [ref=f7e174] [cursor=pointer]:
              - /url: /web/index.php/pim/viewMemberships/empNumber/340
      - generic [ref=f7e175]:
        - generic [ref=f7e176]:
