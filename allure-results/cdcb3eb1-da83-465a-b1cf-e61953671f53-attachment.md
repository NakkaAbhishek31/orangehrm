...
- Name: Performance\performance.spec.ts >> Performance - Employee Reviews >> TC_PERFORMANCE_225 - Reset should clear all dropdowns @positive @reset @regression
- Location: tests\Performance\performance.spec.ts:677:7
