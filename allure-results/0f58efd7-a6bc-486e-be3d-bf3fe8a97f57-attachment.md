...
- Name: Admin\admin-users.spec.ts >> Admin - System Users >> TC_PIM_071 - Deleted employee should not appear in search results @positive @delete @regression
- Location: tests\Admin\admin-users.spec.ts:849:7
...
Locator:  locator('.oxd-table-body .oxd-table-card').filter({ hasText: '0594' })
Expected: 1
Received: 0
Timeout:  10000ms
...
Call log:
  ...
  - waiting for locator('.oxd-table-body .oxd-table-card').filter({ hasText: '0594' })
