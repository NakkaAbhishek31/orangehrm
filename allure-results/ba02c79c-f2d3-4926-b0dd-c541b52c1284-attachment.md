...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'AutoA1786453033035449 Test User' }).first()
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'AutoA1786453033035449 Test User' }).first()
...
- textbox "Type for hints...": AutoA1786453033035449 Test User
- listbox:
