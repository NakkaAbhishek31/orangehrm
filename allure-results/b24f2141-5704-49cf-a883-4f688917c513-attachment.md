...
- Name: Performance\performance.spec.ts >> Performance - Employee Reviews >> TC_PERFORMANCE_210 - Selected job title should remain after searching reviews @positive @filter @persistence @regression
- Location: tests\Performance\performance.spec.ts:368:7
