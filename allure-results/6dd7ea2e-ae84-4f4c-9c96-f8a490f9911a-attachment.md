...
- Location: tests\PIM\pim-employee-list.spec.ts:222:7
...
Call log:
  - waiting for locator('.oxd-table-body .oxd-table-card').filter({ hasText: '0681' }).locator('.oxd-table-cell').nth(2)
