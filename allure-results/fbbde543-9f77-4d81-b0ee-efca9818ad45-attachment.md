        ...
        - list [ref=f4e123]:
          - listitem [ref=f4e124]:
            - generic [ref=f4e125] [cursor=pointer]:
              ...
              - paragraph [ref=f4e127]: Shriyansh Bendkhale
              - generic [ref=f4e128]: 
      ...
      - generic [ref=f4e160]:
        - generic [ref=f4e162]:
          ...
          - generic [ref=f4e192]:
            ...
            - textbox [ref=f4e196]: ess1785827461099360
        - generic [ref=f4e198]:
          - generic [ref=f4e199]:
            - generic [ref=f4e200]:
...
```ts
  ...
  218 |     this.confirmPasswordValidation = page
  219 |       .locator(".oxd-input-group")
  220 |       .filter({
  221 |         has: page.getByText("Confirm Password", {
  222 |           exact: true,
  223 |         }),
  224 |       })
