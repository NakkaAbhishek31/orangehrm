      ...
      - generic [ref=f4e160]:
        - generic [ref=f4e162]:
          ...
          - generic [ref=f4e192]:
            ...
            - textbox [ref=f4e196]: ess178590061036972
        - generic [ref=f4e198]:
          - generic [ref=f4e199]:
            - generic [ref=f4e200]:
...
> 335 |     await this.searchButton.click();
  ...
  427 |     );
  428 | 
  429 |     const systemUsersPage = this.page.waitForURL(/admin\/viewSystemUsers/, {
  430 |       timeout: 20_000,
  431 |     });
  432 | 
  433 |     // Begin watching for the temporary toast
  434 |     // before clicking Save.
  435 |     const successToastAppears = expect(this.successToast).toContainText(
```