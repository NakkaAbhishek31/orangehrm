...
- Name: Performance\performance.spec.ts >> Performance - Employee Reviews >> TC_PERFORMANCE_239 - Available dropdown values should be selectable @positive @filter @regression
- Location: tests\Performance\performance.spec.ts:870:7
...
Received string:    "Account Assistant"
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('form').locator('.oxd-input-group').filter({ has: locator('label').getByText('Job Title', { exact: true }) }).locator('.oxd-select-text')
    42 × locator resolved to <div data-v-67d2aedf="" data-v-13cf171c="" class="oxd-select-text oxd-select-text--active">…</div>
       - unexpected value "Account Assistant"
