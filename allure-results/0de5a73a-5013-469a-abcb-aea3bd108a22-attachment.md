...
- Name: Admin\admin-users.spec.ts >> Admin - System Users >> TC_PIM_077 - Employee should remain searchable after navigating away and returning @positive @navigation @regression
- Location: tests\Admin\admin-users.spec.ts:990:8
            ...
            - row [ref=f5e268] [cursor=pointer]:
              - cell "" [ref=f5e269]:
                - generic [ref=f5e272]:
                  - checkbox "" [ref=f5e273]
                  - generic [ref=f5e274]: 
              - cell "229871800" [ref=f5e276]
              - cell "Persist1786522982891296 Test" [ref=f5e278]
