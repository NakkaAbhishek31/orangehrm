...
- Location: tests\Admin\admin-users.spec.ts:2001:6
...
- banner:
  ...
  - list:
    - listitem:
      - img "profile picture"
      - paragraph: KawasakiSomnathtest RS
      - text: 
...
- table:
  ...
  - rowgroup:
    - row " ess1785909525892753 ESS Auto1785909525892753 User Disabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "ess1785909525892753"
      - cell "ESS"
      - cell "Auto1785909525892753 User"
      - cell "Disabled"
      - cell " ":
        - button ""
        - button ""
...
```ts
  ...
  1999 | });
  2000 | 
  2001 | test.only("TC_ADMIN_066 - Admin should filter System Users by disabled status @positive @filter @status @regression", async ({
  2002 |   loginPage,
  2003 |   navigationPage,
  2004 |   pimPage,
  2005 |   adminPage,
