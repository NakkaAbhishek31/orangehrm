...
- Name: Admin\admin-users.spec.ts >> TC_ADMIN_067 - Admin should open an existing System User for editing @positive @navigation @edit @regression
- Location: tests\Admin\admin-users.spec.ts:2130:5
