...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1785572989507 test user' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1785572989507 test user' })
  ...
  - rowgroup:
    ...
    - row " 0440 CancelTest572727 AutoCancel  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " 0447 CancelTest572828 AutoCancel  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "0447"
      - cell "CancelTest572828"
      - cell "AutoCancel"
      - cell
      - cell
      - cell
    ...
    - row " 1967 Custom IDTest  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " 0445 DelTest572809 AutoDelete  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "0445"
