...
- Location: tests\PIM\pim-employee-list.spec.ts:95:8
...
```ts
  ...
  93  |   });
  94  | 
  95  |   test.only("TC_PIM_005 - Admin should search using employee ID and employee name @positive @regression", async ({
  96  |     page,
  97  |     navigationPage,
  98  |     pimPage,
  99  |   }) => {
