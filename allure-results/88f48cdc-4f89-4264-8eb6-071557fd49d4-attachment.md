...
- Name: Recruitment\recruitment.spec.ts >> Recruitment - Candidates >> TC_RECRUITMENT_134 - Admin should search Candidates using a valid application date range @positive @search @regression
- Location: tests\Recruitment\recruitment.spec.ts:72:7
...
Locator:  locator('form .oxd-input-field-error-message')
Expected: 0
Received: 2
Timeout:  20000ms
...
Call log:
  ...
  - waiting for locator('form .oxd-input-field-error-message')
    43 × locator resolved to 2 elements
       - unexpected value "2"
        ...
        - generic [ref=f3e152]:
          ...
          - generic [ref=f3e196]:
            ...
            - generic [ref=f3e212]:
              ...
              - generic [ref=f3e217]:
                - textbox "From" [ref=f3e218]: 2026-28-07
...
```ts
  ...
  18  | };
  19  | 
  20  | test.describe("Recruitment - Candidates", () => {
  21  |   test.beforeEach(async ({ loginPage }) => {
  22  |     await loginPage.visitPage();
  23  |     await loginPage.login(
  24  |       loginData.validAdmin.username,
  25  |       loginData.validAdmin.password,
  26  |     );
  27  |     await loginPage.verifyLoginSuccessful();
  28  |   });
  29  | 
  30  |   test("TC_RECRUITMENT_133 - Admin should navigate to the Candidates page @smoke @navigation @regression", async ({
  31  |     page,
  32  |     navigationPage,
  33  |     recruitmentPage,
  34  |   }) => {
  35  |     const data = recruitmentData.TC_RECRUITMENT_133;
  36  |     // Click Recruitment in the main navigation.
  37  |     await navigationPage.gotoRecruitment();
  38  |     // Navigate to Candidates.
  39  |     await recruitmentPage.navigateToCandidate();
  40  |     // Verify the Candidates URL.
  41  |     await expect(page).toHaveURL(new RegExp(`${data.expectedUrlPath}$`));
  42  |     // Verify the Candidates heading.
  43  | 
  44  |     await expect(recruitmentPage.candidatePageHeading).toHaveText(
  45  |       data.pageHeading,
  46  |     );
