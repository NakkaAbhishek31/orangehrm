...
- Location: tests\Admin\admin-users.spec.ts:1477:7
...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'ResetAll1786454388566857' }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'ResetAll1786454388566857' }).first()
...
- separator
- text: Employee Name
- textbox "Type for hints...": ResetAll1786454388566857
- listbox:
