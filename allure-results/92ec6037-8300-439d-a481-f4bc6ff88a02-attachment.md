...
Locator:  locator('.oxd-table-body .oxd-table-card').locator('input[type="checkbox"]').nth(48)
Expected: checked
Received: unchecked
Timeout:  20000ms
...
Call log:
  ...
  - waiting for locator('.oxd-table-body .oxd-table-card').locator('input[type="checkbox"]').nth(48)
    43 × locator resolved to <input type="checkbox" data-v-6179b72a=""/>
