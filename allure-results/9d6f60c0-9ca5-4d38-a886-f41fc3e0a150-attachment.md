...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1785495578656 test user' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1785495578656 test user' })
...
- listbox:
  ...
  - option "Auto1785493785533 Test User"
