          ...
          - generic [ref=f5e161]:
            - generic [ref=f5e162]:
              - generic [ref=f5e165]:
                ...
                - generic [ref=f5e168]:
                  - textbox "First Name" [ref=f5e171]
                  - textbox "Middle Name" [ref=f5e174]
                  - textbox "Last Name" [ref=f5e177]
              - generic [ref=f5e180]:
                - generic [ref=f5e181]: Employee Id
                - textbox [ref=f5e184]: "0534"
            - separator [ref=f5e185]
            - generic [ref=f5e186]:
              - paragraph [ref=f5e187]: Create Login Details
              - checkbox [ref=f5e190]
        - separator [ref=f5e192]
        - generic [ref=f5e193]:
          - paragraph [ref=f5e194]: "* Required"
          - button "Cancel" [ref=f5e195] [cursor=pointer]
          - button "Save" [ref=f5e196] [cursor=pointer]
    - generic [ref=f5e197]:
      - paragraph [ref=f5e198]: OrangeHRM OS 5.9
      - paragraph [ref=f5e199]:
        - text: © 2005 - 2026
        - link "OrangeHRM, Inc" [ref=f5e200] [cursor=pointer]:
