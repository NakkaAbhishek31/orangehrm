...
- Location: tests\Admin\admin-users.spec.ts:988:7
...
Call log:
  - waiting for locator('.oxd-table-body .oxd-table-card').filter({ hasText: '0547' }).locator('.oxd-table-cell').nth(2)
