...
- Name: Admin\admin-users.spec.ts >> Admin - System Users >> TC_PIM_099 - Reset should clear employee ID and name together @positive @filter @regression
- Location: tests\Admin\admin-users.spec.ts:1538:7
    ...
    - generic [ref=f5e146]:
      ...
      - generic [ref=f5e226]:
        - button " Add" [ref=f5e228] [cursor=pointer]:
          ...
          - text: Add
        - table [ref=f5e231]
        - navigation "Pagination Navigation" [ref=f5e236]:
          - list [ref=f5e237]:
            - listitem [ref=f5e238]:
              - button "1" [ref=f5e239] [cursor=pointer]
            - listitem [ref=f5e240]:
              - button "2" [ref=f5e241] [cursor=pointer]
            - listitem [ref=f5e242]:
              - button "3" [ref=f5e243] [cursor=pointer]
            - listitem [ref=f5e244]:
              - button "4" [ref=f5e245] [cursor=pointer]
            - listitem [ref=f5e246]:
              - button "" [ref=f5e247] [cursor=pointer]
    - generic [ref=f5e249]:
      - paragraph [ref=f5e250]: OrangeHRM OS 5.9
      - paragraph [ref=f5e251]:
        - text: © 2005 - 2026
        - link "OrangeHRM, Inc" [ref=f5e252] [cursor=pointer]:
