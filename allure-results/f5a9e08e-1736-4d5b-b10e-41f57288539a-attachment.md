...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786433087143227 Test User' }).first()
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786433087143227 Test User' }).first()
...
- textbox "Type for hints...": Auto1786433087143227 Test User
- listbox:
