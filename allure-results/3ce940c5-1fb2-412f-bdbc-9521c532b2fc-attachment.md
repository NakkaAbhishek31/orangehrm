...
- Location: tests\Admin\admin-users.spec.ts:543:7
...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786432911429872 Test User' }).first()
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1786432911429872 Test User' }).first()
...
- textbox "Type for hints...": Auto1786432911429872 Test User
- listbox:
