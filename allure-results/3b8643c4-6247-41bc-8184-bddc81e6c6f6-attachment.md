...
- separator
- text: Name
- paragraph: CancelReject1787642526912 Test Candidate
- text: Vacancy
- paragraph: N/A
- text: Hiring Manager
- paragraph: N/A
...
- separator
- text: Full Name*
- textbox "First Name" [disabled]: CancelReject1787642526912
- textbox "Middle Name" [disabled]: Test
- textbox "Last Name" [disabled]: Candidate
- text: Job Vacancy -- Select --  Email*
- textbox "Type here" [disabled]: cancelreject1787642526912@example.com
- text: Contact Number
...
- table:
  ...
  - rowgroup:
    - row "2026-25-08 Emp_YJQynJ Opens User_KwCyeJnB added CancelReject1787642526912 Test Candidate":
      - cell "2026-25-08"
      - cell "Emp_YJQynJ Opens User_KwCyeJnB added CancelReject1787642526912 Test Candidate"
      - cell
