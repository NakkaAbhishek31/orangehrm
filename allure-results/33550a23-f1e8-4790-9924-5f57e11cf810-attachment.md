...
Locator: locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1785495018296' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('.oxd-autocomplete-option').filter({ hasText: 'Auto1785495018296' })
...
- listbox:
  ...
  - option "Auto1785494581100 Test User"
- text: Employee Id
- textbox
