...
- Location: tests\Admin\admin-users.spec.ts:1294:7
...
Locator:  locator('.oxd-table-body .oxd-table-card').filter({ hasText: '0596' })
Expected: 1
Received: 0
Timeout:  10000ms
...
Call log:
  ...
  - waiting for locator('.oxd-table-body .oxd-table-card').filter({ hasText: '0596' })
