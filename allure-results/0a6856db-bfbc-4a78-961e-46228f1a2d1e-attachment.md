...
Call log:
  ...
  - waiting for locator('.oxd-loading-spinner').first()
    12 × locator resolved to <div data-v-a6dfc6a9="" class="oxd-loading-spinner"></div>
...
- generic [ref=f4e3]:
  ...
  - generic [ref=f4e144]:
    - generic [ref=f4e148]:
      - generic [ref=f4e149]:
        - generic [ref=f4e150]:
          - heading "Auto1785912086878 user" [level=6] [ref=f4e152]
      ...
      - generic [ref=f4e177]:
        - generic [ref=f4e178]:
          ...
          - generic [ref=f4e181]:
            - generic [ref=f4e188]:
              ...
              - generic [ref=f4e191]:
                - textbox "First Name" [ref=f4e194]: Auto1785912086878
        ...
        - generic [ref=f4e313]:
          ...
          - table [ref=f4e321]
    - generic [ref=f4e325]:
      - paragraph [ref=f4e326]: OrangeHRM OS 5.9
      - paragraph [ref=f4e327]:
        - text: © 2005 - 2026
        - link "OrangeHRM, Inc" [ref=f4e328] [cursor=pointer]:
