...
- Name: Admin\admin-users.spec.ts >> Admin - System Users >> TC_PIM_102 - Admin should find employee after refreshing Employee List @positive @search @regression
- Location: tests\Admin\admin-users.spec.ts:1548:7
...
Call log:
  - waiting for locator('.oxd-table-body .oxd-table-card').filter({ hasText: '0599' }).locator('.oxd-table-cell').nth(2)
