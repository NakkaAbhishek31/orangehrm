...
- Location: tests\Recruitment\recruitment.spec.ts:1678:7
...
- separator
- text: Name
- paragraph: Shortlist1787038647145 Test User
- text: Vacancy
- paragraph: N/A
- text: Hiring Manager
- paragraph: N/A
...
- separator
- text: Full Name*
- textbox "First Name" [disabled]: Shortlist1787038647145
- textbox "Middle Name" [disabled]: Test
- textbox "Last Name" [disabled]: User
- text: Job Vacancy -- Select --  Email*
- textbox "Type here" [disabled]: shortlistcandidate1787038647145@example.com
- text: Contact Number
...
- table:
  ...
  - rowgroup:
    - row "2026-18-08 manda akhil userTester added Shortlist1787038647145 Test User":
      - cell "2026-18-08"
      - cell "manda akhil userTester added Shortlist1787038647145 Test User"
      - cell
...
```ts
  ...
  1676 |   });
  1677 | 
  1678 |   test("TC_RECRUITMENT_156 - Admin should shortlist an existing candidate successfully @positive @workflow @regression", async ({
  1679 |     page,
  1680 |     navigationPage,
