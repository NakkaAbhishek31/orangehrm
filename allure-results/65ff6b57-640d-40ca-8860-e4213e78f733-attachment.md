...
- Name: login.spec.ts >> TC_LOGIN_006 - Required validation should appear when password is empty @negative @validation @regression
- Location: tests\login.spec.ts:54:5
